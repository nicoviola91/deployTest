                        ...
                        @if(isset($fichaFamiliaAmigos))
                            ...
                            @foreach($contactos as $contacto)
                                <div class="box-tools pull-right">
                                    ...
                                    <a href="{{ route('fichaFamiliaAmigos.destroyContacto',['contacto_id'=>$contacto->id,'asistido_id'=>$asistido->id])}}" class="descartarBtn" data-id="{{$contacto->id}}" data-toggle="tooltip" data-title="Descartar Contacto">
